...
namespace GUI
{
	...
	GUI::GUI(GLFWwindow* windowID, std::string title /*= ""*/, glm::vec2 position /*= glm::vec2(0.5f, 0.5f)*/, glm::vec4 color /*= glm::vec4(0.1f, 0.4f, 0.3f, 1.f)*/, float width /*= 0.f*/, float hight /*= 0.2*/, std::string pahtToThisHeaderFile) :
		m_titleText(title),
		m_position(position),
		m_color(color),
		m_width(width),
